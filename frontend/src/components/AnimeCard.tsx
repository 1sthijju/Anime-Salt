  ...
  return (
    ...
    >
      <div className="relative aspect-[2/3] overflow-hidden rounded-xl border border-line/60 bg-card transition duration-300 group-hover:border-accent/60 group-hover:shadow-glow">
        <img src={item.image} alt={item.title} loading="lazy" className="h-full w-full object-cover transition duration-300 group-hover:scale-105" />
        ...
        {rank != null && (
          <span className="absolute left-2 top-1 font-display text-2xl font-extrabold text-white/90"
